export default function AboutMeSection() {
  return (
    <section
      id="AboutMe"
      className="flex flex-col justify-center bg-white pt-6 px-32 h-screen text-center"
    >
      <div>
        <p>About Me</p>
      </div>
      <div>
        <p>
          ...
          React, Tailwind, and Node.js. <br />
          O
          <br />
          Able to create custom solutions to meet unique client needs while
          ensuring optimal performance and scalability.
          <br />
          O
          <br />
          Dedicated to continuous learning and leveraging the latest tools to
